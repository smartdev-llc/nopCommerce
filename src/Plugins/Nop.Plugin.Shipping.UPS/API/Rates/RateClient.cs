...
namespace Nop.Plugin.Shipping.UPS.API.Rates
{
    ...
    public partial class RateClient
    {
        ...
        /// <param name="version">Indicates Rate API to display the new release features in Rate API response based on Rate release. See the New section for the latest Rate release. Supported values: v1, v1601, v1607, v1701, v1707, v2108, v2205. Length 5</param>
        /// <param name="requestoption">Valid Values: Rate = The server rates (The default Request option is Rate if a Request Option is not provided). Shop = The server validates the shipment, and returns rates for all UPS products from the ShipFrom to the ShipTo addresses. Rate is the only valid request option for Ground Freight Pricing requests. . Length 10</param>
        ...
        public virtual async System.Threading.Tasks.Task<RATEResponseWrapper> RateAsync(string transId, string transactionSrc, string additionalinfo, string version, string requestoption, RATERequestWrapper body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/rating/{version}/{requestoption}?");
            ...
            urlBuilder_.Replace("{requestoption}", System.Uri.EscapeDataString(ConvertToString(requestoption, System.Globalization.CultureInfo.InvariantCulture)));
            if (additionalinfo != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("additionalinfo") + "=").Append(System.Uri.EscapeDataString(ConvertToString(additionalinfo, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 401)
                        {
                            ...
                            throw new ApiException("Unauthorized Request", status_, responseText_, headers_, null);
                        }
                        else
                        {
    ...
    {
        /// <summary>
        /// Code for Shipment Indication Type.Valid values: 01 - Hold for Pickup at UPS Access Point 02 - UPS Access Point Delivery
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Code", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(2, MinimumLength = 2)]
    ...
    public partial class Package_Dimensions
    {
        ...
        /// <summary>
        /// The length of the line item used to determine dimensional weight. 6 digits in length with 2 digits of significance after the decimal point.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Length", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(9, MinimumLength = 1)]
        ...
        /// <summary>
        /// The width of the line item used to determine dimensional weight. 6 digits in length with 2 digits of significance after the decimal point.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Width", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(9, MinimumLength = 1)]
        ...
        /// <summary>
        /// The height of the line item used to determine dimensional weight. 6 digits in length with 2 digits of significance after the decimal point.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Height", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(9, MinimumLength = 1)]
    ...
    {
        /// <summary>
        /// Type of delivery confirmation.  Valid values: 2 - Delivery Confirmation Signature Required 3 - Delivery Confirmation Adult Signature Required
        /// </summary>
    ...
    public partial class PackageServiceOptions_AccessPointCOD
    {
        ...
        /// <summary>
        /// Access Point COD Monetary Value.  Required if Access Point COD container is present. 8 digits prior to the decimal place and 2 after.
        /// </summary>
    ...
    {
        /// <summary>
        /// DryIce weight unit of measurement code. Valid values: 00 = KG (Metric Unit of Measurements) or KGS 01 = LB (English Unit of Measurements)
        /// </summary>
        [Newtonsoft.Json.JsonProperty("Code", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(2, MinimumLength = 1)]
    ...
    public partial class Shipment_InvoiceLineTotal
    {
        ...
        /// <summary>
        /// Total amount of the invoice accompanying the shipment. Required when the InvoiceLineTotal container exists in the rate request.  Valid values are from 1 to 99999999.00
        /// </summary>
        [Newtonsoft.Json.JsonProperty("MonetaryValue", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(19, MinimumLength = 1)]
    ...
    public partial class RatedShipment_TimeInTransit
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.Generic.ICollection<TimeInTransit_ServiceSummary> ServiceSummary { get; set; } = new System.Collections.ObjectModel.Collection<TimeInTransit_ServiceSummary>();
